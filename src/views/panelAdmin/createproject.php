...
<?php ob_start(); ?>
<h1>Création d'un article par l'administateur <?= $_SESSION['name'] ?></h1>
...
<form method='post' id='ajout' action='' class='ligne'>
    <label for='title'>Titre du projet</label><input type='text' name='title' placeHolder="Titre du projet" />
    <label for='category'>Catégorie </label><input type='text' name='category'  placeHolder="Catégorie du projet" />
    <label for=''>Description du projet</label>
    <div id='editor'></div>
    <label for='dateProject'>Date du projet</label><input type='text' name='dateProject'  placeHolder="Date du projet" />
